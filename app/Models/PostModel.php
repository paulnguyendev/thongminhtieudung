...
class PostModel extends Model
{
    ...
    protected $fillable = ['title','slug','thumbnail','description','content','created_at','updated_at'];
    use HasFactory;
    public function listItems($params = "", $options = "")
    {
        $result = null;
        $query = $this->select('id','title','slug','thumbnail','description','content','created_at','updated_at');
