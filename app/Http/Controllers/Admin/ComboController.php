...
{
    private $pathViewController     = "admin.pages.combo.";
    private $controllerName         = "admin_combo";
    private $title         = "Combo";
    private $model;
    private $params                 = [];
    ...
    public function dataList(Request $request)
    {
        ...
        $data = array_map(function ($item) {
            $id = $item['id'];
            $slug = $item['slug'];
            $item['route_edit'] = route('admin_combo/form', ['id' => $id]);
            $item['published_at'] = "";
            $item['description'] = [
                'title' => $item['title'],
            ];
