...
@section('navbar-right')
    <li>
        <a href="{{ route('admin_post/form') }}" style="padding:5px 5px">
            <button class="btn bg-info heading-btn" type="button">Tạo bài viết</button>
        </a>
    </li>
@endsection
@section('content')
    <div class="panel panel-flat">
        <table class="table table-xlg datatable-ajax" data-source="{{ route('admin_post/dataList') }}"
            data-destroymulti="{{ route('admin_post/destroyMulti') }}">
            <thead>
                <tr>
