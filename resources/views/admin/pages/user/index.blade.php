...
@section('content')
    <div class="panel panel-flat">
        <table class="table table-xlg datatable-ajax" data-source="{{ route('admin_user/dataList') }}"
            data-destroymulti="{{ route('admin_user/destroy-multi') }}">
            <thead>
                <tr>
                    ...
                    <th>Thông tin người giới thiệu</th>
                    <th width="180" class="text-center">Ngày tham gia</th>
                    <th width="10"></th>
                </tr>
            </thead>
            <tbody></tbody>
        ...
        if ($('.datatable-ajax').length) {
            var columnDatas = [{
                ...
                },
                {
                    data: null,
                    render: function(data) {
                        return WBDatatables.showTitle(data.code, data.route_detail, data.is_published,
                            data.published_at);
                    },
                    orderable: false,
                    searchable: false
                ...
                },
                {
                    data: null,
                    render: function(data) {
                        return (!data.parentInfo) ? '' : data.parentInfo
                    },
                    orderable: false,
                    searchable: false
                },
